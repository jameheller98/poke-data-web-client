...
const Footer: React.FC = React.memo(function Footer() {
  ...
  return (
    <>
      <div className={`container mx-auto mt-3 mb-6${width < 1028 || width > 1280 ? ' px-6 ' : ' '}text-gray-700`}>
        <div className="py-3">
          ...
          <a href="mailto:nhoktuan1135789@gmail.com" aria-label="Gmail" target="_blank" rel="noreferrer">
            ...
            >
              ...
              <linearGradient id="lg4">
                <stop offset="0" stopColor="#f90217" stopOpacity="0" />
                <stop offset=".2669" stopColor="#e7010f" stopOpacity=".267" />
                <stop offset=".7232" stopColor="#ce0004" stopOpacity=".723" />
              ...
              <linearGradient
                id="color8"
                gradientTransform="matrix(-1 0 0 1 971.233 0)"
                gradientUnits="userSpaceOnUse"
                x1="962"
                x2="920"
                xlinkHref="#lg4"
        ...
        <address className="my-3 text-xs">
          Icons made by{' '}
          <a className="text-blue-700" href="https://www.freepik.com" title="Freepik" target="_blank" rel="noreferrer">
            Freepik
          </a>{' '}
          from{' '}
          <a
